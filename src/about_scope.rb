...
class AboutScope < Neo::Koan
  ...
  def test_dog_is_not_available_in_the_current_scope
    assert_raise(NameError) do #  #<NameError: uninitialized constant AboutScope::Dog>
      Dog.new
    end
  end
  ...
  def test_you_can_get_a_list_of_constants_for_any_class_or_module
    ...
    assert Object.constants.size > Neo::Koan.subclasses.size # includes at least all classes/modules declared in the koans (1st level only)
  end
end
