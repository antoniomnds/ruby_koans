...
class AboutToStr < Neo::Koan
  ...
  class CanNotBeTreatedAsString
    def to_s # string representation of an object that does not act like a string
      "non-string-like"
    end
  end
  ...
  class CanBeTreatedAsString
    ...
    def to_str # implemented when the object can naturally be used in every place as a string (acts like string)
      to_s
    end
  end
