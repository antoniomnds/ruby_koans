...
class AboutClassMethods < Neo::Koan
  ...
  def test_objects_have_methods
    fido = Dog.new
    assert fido.methods.size > 0 # in fact, in the order of 60 methods (62)
  end

  def test_classes_have_methods
    assert Dog.methods.size > 0 # in fact, over 100 methods (116)
  end

  def test_you_can_define_methods_on_individual_objects
    fido = Dog.new
    def fido.wag # what they call a singleton method!
      :fidos_wag
    end
  ...
  # I would prefer the second way if I have more than one class method.
  # It's a way of grouping them, which improves readability.
