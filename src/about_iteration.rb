...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    # Takes an initial value and a block, and applies the block to each element in the collection while
    # having access to an accumulator (first parameter) and the current element (second parameter).
  end
  ...
  #
  # The file is automatically closed when the block is done,
  #  where in the second form one has to manually close the file.
