...
class AboutBlocks < Neo::Koan
  ...
  def method_with_explicit_block(&block) # leading ampersand converts a block into a Proc object
    block.call(10)
  end
  ...
  def test_methods_can_take_an_explicit_block_argument
    ...
    add_one = lambda { |n| n + 1 }
    assert_equal 11, method_with_explicit_block(&add_one) # & converts a lambda (special type of Proc) into a block
  end
